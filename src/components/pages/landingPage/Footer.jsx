...
const Footer = () => {
  return (
    <div className="px-7 md:px-[6.25rem] py-[4.5rem] bg-[#092866] text-white text-[0.75rem]">
      <div className="flex flex-col gap-y-10 md:gap-y-0 md:flex-row items-center md:items-start md:justify-between">
        <div>
          <h3 className="text-[1.25rem]">AFIP MedLog</h3>
          <p className="w-full md:w-[25.4375rem] py-[0.5rem]">
