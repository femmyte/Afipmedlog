  ...
  return (
    <div className="py-[4.5rem] flex flex-col justify-center items-center w-full">
      <div className="flex flex-col text-center justify-center items-center">
        ...
        <p className="md:w-[38.0625rem] px-[1.5rem] mt-[1rem] text-[#5F5F5F]">
          AFIPMedLog is a very simple application that involves few steps to
          complete.
        </p>
      </div>
      <div className="flex flex-col gap-y-7 md:gap-y-0 md:flex-row items-center justify-center text-center px-7 md:px-[6.25rem] mt-[2.5rem]">
        <ServicesCard
