  ...
  return (
    <div>
      ...
      <div className="overflow-x-auto">
        <div className="flex gap-x-5 w-max mt-[1.5rem]">
          <div className="flex border-[0.4px] bg-[#F9F9F9] border-[#D1D1D1]  p-[0.5rem] rounded-[0.25rem]">
            <Image
          ...
          <div className="flex items-center text-[0.875rem] text-[#7F7F7F] border-[0.4px] bg-[#F9F9F9] border-[#D1D1D1]  p-[0.5rem]  rounded-[0.25rem]">
        ...
        <div>
          <table className="w-full">
            <thead className="w-full">
              <tr className="text-[0.875rem] w-full">
                ...
                <td className="font-normal py-[0.88rem] border-b-[1px] ml-3">
                  Status
                </td>
              ...
              {sharedHealthRecord &&
                sharedHealthRecord.map((item, id) => (
                  ...
                  >
                    ...
                    <td className="py-[0.88rem] border-b-[1px] ml-3 border-[#F2F2F2] text-[#16B61C]">
                      Active
                    </td>
                    {/* <td className="py-[0.88rem] border-b-[1px] border-[#F2F2F2]">
                      ...
